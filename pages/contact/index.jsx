    ...
    <DefaultLayout>
      ...
      <div className="flex flex-col-reverse items-center justify-center my-24 gap-6 md:flex-row">
        <div className="flex-1 flex flex-col w-full  gap-4 mt-10">
          <Button route="https://github.com/Ar3secchim" variant="outline" blank>
            GitHub
            <PiArrowUpRightBold />
          </Button>
        ...
        <Image
          ...
          className="w-full md:w-1/2 pb-6 px-4 border-input bg-background shadow-sm hover:bg-accent hover:scale-105 
          transform transition-transform duration-700 ease-in-out  border rounded-md border-zinc-900"
          src={Avatar}
        />
      </div>
    </DefaultLayout>
