      ...
      <section>
        ...
        <ul className="my-8 flex flex-col gap-1 font-thin">
          ...
          <li className="inline-flex gap-1 items-center mx-2">
            <FaAngleRight /> <bold>INTJ-A Myers-Briggs:</bold> “Os protagonistas
            estão inspirando otimistas, prontamente agindo para fazer o que
            acham certo. Esses tipos calorosos e francos adoram ajudar os outros
            e têm a energia criativa para alcançar seus objetivos.”
          </li>
          <li className="inline-flex gap-1 items-center mx-2">
        ...
        <ul className="my-8 flex flex-col gap-1 font-thin">
          ...
          <li className="inline-flex gap-1 items-center mx-2">
            <FaAngleRight /> Modo Aprendiz ligado: Toda pessoa, independente da
            sua idade, classe social ou nivel de educação tem algo a ensinar
            indepedente do assunto: seja sobre a vida, relacionamento,
            carreira...
          </li>
          <li className="inline-flex gap-1 items-center mx-2">
            <FaAngleRight /> Viés para o apredizado: Começar é a melhor maneira
            de começar a progredir e começar a aprender.
          </li>
          <li className="inline-flex gap-1 items-center mx-2">
            <FaAngleRight /> Mentalidade de crescimento: Estou constantemente me
            desafiando a melhorar. Quando fico muito confortável, minha
            felicidade sofrem.
          </li>
          <li className="inline-flex gap-1 items-center mx-2">
            <FaAngleRight />
