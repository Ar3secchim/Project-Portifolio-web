    ...
    <Container ClassName="text-center h-full">
      ...
      <section>
         ...
         <div className="flex flex-col lg:grid lg:grid-cols-3 gap-8">
          <div className="flex flex-col justify-center gap-4 text-center p-4 rounded-2xl border-gray-300 border-2 transition hover:scale-110">
            <img className="" src={knonwledge} />
            <p>Ninguém sabe tudo. Sempre em buscar de conhecimento.</p>
          </div>

          <div className="flex flex-col justify-center items-center gap-2 text-center p-4 rounded-2xl border-gray-300 border-2 transition hover:scale-110" >
          ...
          <div className="flex flex-col gap-2 justify-center items-center text-center col-span-3 p-4 rounded-2xl border-gray-300 border-2 transition  hover:scale-110">
