    ...
    <div>
     ...
     <Container  ClassName=" bg-zinc-950">
      ...
      <Container ClassName="bg-[#CECECE] items-center text-black">
        ...
        <Container  id="about2" ClassName="bg-[#262626] flex-col text-lg gap-6 lg:gap-16 lg:text-[36px] text-center font-thin justify-center ">
          <ContainerRoot ClassName="flex-col gap-8 items-center">
